...
return [
  'up' => "CREATE TABLE `Signal` (
    ...
    `pressure`     float DEFAULT NULL COMMENT '氣壓',
    `temperature`  float DEFAULT NULL COMMENT '溫度',
    `humidity`     float DEFAULT NULL COMMENT '濕度',

    `timeAt`       datetime DEFAULT NULL COMMENT '時間',
    `cntSatellite` tinyint(4) unsigned NOT NULL DEFAULT '0' COMMENT '衛星數量',

    `updateAt`     datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新時間',
    `createAt`     datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '新增時間',
    PRIMARY KEY (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='訊號';",

  'down' => "DROP TABLE IF EXISTS `Signal`;",

  'at' => "2019-08-24 23:52:02"
];
